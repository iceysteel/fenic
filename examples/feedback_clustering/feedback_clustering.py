...
def create_session_config(language_model_provider: str, language_model_name: str,
    ...
    # Configure embedding models - use defaults if not specified
    if embedding_model_provider and embedding_model_name:
        ...
        # Default to OpenAI embedding for this example since it uses clustering
        embedding_model = fc.OpenAIEmbeddingModel(
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Customer Feedback Clustering Example")
